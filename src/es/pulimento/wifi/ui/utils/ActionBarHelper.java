 ...
 * in the app. This
 * class provides functionality useful for both phones and tablets, and does not
 * require any Android
 ...
 * pre-Honeycomb version of
 * the action bar, and {@link ActionBarHelperHoneycomb}, which uses the built-in
 * ActionBar features
...
public abstract class ActionBarHelper {
	 ...
	 * method in {@link ActionBarHelperBase} returns a wrapped menu inflater
	 * that can read
